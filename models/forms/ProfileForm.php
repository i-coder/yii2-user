...
class ProfileForm extends User
{
    ...
    {
        return [
            [['first_name','work'], 'required'],   // Обязательно для заполнения
            ...
            [['first_name', 'last_name', 'email', 'phone', 'address','home_phone'], 'filter', 'filter' => 'trim'],   // Обрезание строк по краям
            [['last_name', 'password_reset_token', 'email_confirm_token',
                'image', 'sex', 'phone','home_phone', 'country_id', 'city_id', 'address',
