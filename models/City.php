...
class City extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['country_id', 'name', 'region'], 'required'], // Обязательные для заполнения
            [['country_id', 'biggest_city'], 'integer'],    // Целочисленные значения
            [['name', 'state', 'region'], 'string', 'max' => 255],  //  Строковые значения (не более 255 символов)
            [['name', 'region', 'state'], 'filter', 'filter' => 'trim'], // Обрезаем строки по краям
